 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const k=new class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new C(t,e.slice(1),s).parts}if("@"===n)return[new A(t,e.slice(1),i.eventContext)];if("?"===n)return[new P(t,e.slice(1),s)];return new b(t,e,s).parts}handleTextExpression(t){return new x(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const z=(t,...e)=>new g(t,e,"html",k)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`;class st extends tt{constructor(){super(...arguments),this.content=null,this.isContentSet=!1}static get styles(){return et}render(){const t=this.config.nav_items.map(((t,e)=>{const s=t.active?"active":"",i=t.sub_nav_items?t.sub_nav_items.map((t=>`\n                <a href="${t.destination}" class="sub-item ${t.active?"active":""} nav-item-${e}">\n                  <ha-icon icon="${t.icon}"></ha-icon>\n                  <span>${t.name}</span>\n                </a>\n              `)).join(""):"";return z`
