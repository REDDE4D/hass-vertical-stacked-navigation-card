 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function V(t){let e=M.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},M.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const i=t.strings.join(r);return s=e.keyString.get(i),void 0===s&&(s=new d(t,t.getTemplateElement()),e.keyString.set(i,s)),e.stringsArray.set(t.strings,s),s}const M=new Map,O=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const $=(t,...e)=>new g(t,e,"html",k)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function z(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,133,null,!1);let o=U(i),r=i[o],a=-1,l=0;const c=[];let d=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==r&&r.index===a;)r.index=null!==d?-1:r.index-l,o=U(i,o),r=i[o]}c.forEach((t=>t.parentNode.removeChild(t)))}const R=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,133,null,!1);for(;s.nextNode();)e++;return e},U=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(u(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const q=(t,e)=>`${t}--${e}`;let L=!0;void 0===window.ShadyCSS?L=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),L=!1);const j=t=>e=>{const s=q(e.type,t);let i=M.get(s);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},M.set(s,i));let n=i.stringsArray.get(e.strings);if(void 0!==n)return n;const o=e.strings.join(r);if(n=i.keyString.get(o),void 0===n){const s=e.getTemplateElement();L&&window.ShadyCSS.prepareTemplateDom(s,t),n=new d(e,s),i.keyString.set(o,n)}return i.stringsArray.set(e.strings,n),n},H=["html","svg"],F=new Set,I=(t,e,s)=>{F.add(t);const i=s?s.element:document.createElement("template"),n=e.querySelectorAll("style"),{length:o}=n;if(0===o)return void window.ShadyCSS.prepareTemplateStyles(i,t);const r=document.createElement("style");for(let t=0;t<o;t++){const e=n[t];e.parentNode.removeChild(e),r.textContent+=e.textContent}(t=>{H.forEach((e=>{const s=M.get(q(e,t));void 0!==s&&s.keyString.forEach((t=>{const{element:{content:e}}=t,s=new Set;Array.from(e.querySelectorAll("style")).forEach((t=>{s.add(t)})),z(t,s)}))}))})(t);const a=i.content;s?function(t,e,s=null){const{element:{content:i},parts:n}=t;if(null==s)return void i.appendChild(e);const o=document.createTreeWalker(i,133,null,!1);let r=U(n),a=0,l=-1;for(;o.nextNode();)for(l++,o.currentNode===s&&(a=R(e),s.parentNode.insertBefore(e,s));-1!==r&&n[r].index===l;){if(a>0){for(;-1!==r;)n[r].index+=a,r=U(n,r);return}r=U(n,r)}}(s,r,a.firstChild):a.insertBefore(r,a.firstChild),window.ShadyCSS.prepareTemplateStyles(i,t);const l=a.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==l)e.insertBefore(l.cloneNode(!0),e.firstChild);else if(s){a.insertBefore(r,a.firstChild);const t=new Set;t.add(r),z(s,t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`;class st extends tt{constructor(){super(...arguments),this.content=null,this.isContentSet=!1}static get styles(){return et}render(){return $`
      <ha-card>
        ${"none"!==this.config.nav_name?$`
              <header>
                <style>
                  header {
                    padding-top: 10px;
    ...
    `}updated(t){var e,s,i,n,o,r,a,l,c,d,h,u,p,m,f,_,v,g;if(this.content||(this.content=this.shadowRoot.querySelector(".card-content")),!this.isContentSet&&this.content){if(this.isContentSet=!0,this.config.custom_styles){const{colors:t,font_size:y}=this.config.custom_styles;t&&(this.style.setProperty("--main-background-color",null!==(s=null===(e=t.background)||void 0===e?void 0:e.main)&&void 0!==s?s:null),this.style.setProperty("--sub-background-color",null!==(n=null===(i=t.background)||void 0===i?void 0:i.sub)&&void 0!==n?n:null),this.style.setProperty("--main-text-color",null!==(r=null===(o=t.text)||void 0===o?void 0:o.main)&&void 0!==r?r:null),this.style.setProperty("--sub-text-color",null!==(l=null===(a=t.text)||void 0===a?void 0:a.sub)&&void 0!==l?l:null),this.style.setProperty("--main-hover-color",null!==(d=null===(c=t.hover)||void 0===c?void 0:c.main)&&void 0!==d?d:null),this.style.setProperty("--sub-hover-color",null!==(u=null===(h=t.hover)||void 0===h?void 0:h.sub)&&void 0!==u?u:null),this.style.setProperty("--main-active-color",null!==(m=null===(p=t.active)||void 0===p?void 0:p.main)&&void 0!==m?m:null),this.style.setProperty("--sub-active-color",null!==(_=null===(f=t.active)||void 0===f?void 0:f.sub)&&void 0!==_?_:null)),y&&(this.style.setProperty("--main-font-size",null!==(v=y.main)&&void 0!==v?v:null),this.style.setProperty("--sub-font-size",null!==(g=y.sub)&&void 0!==g?g:null))}const t=this.config.nav_items.map(((t,e)=>{const s=t.active?"active":"",i=t.sub_nav_items?t.sub_nav_items.map((t=>`\n                <a href="${t.destination}" class="sub-item ${t.active?"active":""} nav-item-${e}">\n                  <ha-icon icon="${t.icon}"></ha-icon>\n                  <span>${t.name}</span>\n                </a>\n              `)).join(""):"";return`\n          <div class="nav-item-container">\n            <a href="${t.sub_nav_items?"#":t.destination}" class="nav-item ${s} nav-item-${e}">\n              <ha-icon icon="${t.icon}"></ha-icon>\n              <span>${t.name}</span>\n              ${t.sub_nav_items?'<ha-icon icon="mdi:chevron-down" class="subnav-indicator"></ha-icon>':""}\n            </a>\n            <div class="sub-nav-items">${i}</div>\n          </div>\n        `})).join("");this.content.innerHTML=t,this.config.nav_items.forEach(((t,e)=>{if(t.sub_nav_items){const s=this.querySelector(`.nav-item.nav-item-${e}`);s.addEventListener("click",this._toggleSubnav.bind(this));if(t.sub_nav_items.some((t=>t.active))){s.nextElementSibling.style.display="block",s.classList.add("unfolded")}}}))}}setConfig(t){if(!t.nav_items)throw new Error("You need to define nav_items");this.config=t}getCardSize(){return 1*this.config.nav_items.length}_toggleSubnav(t){t.preventDefault();const e=t.target.closest(".nav-item-container");if(!e||!e.querySelector(".sub-nav-items"))return;const s=e.querySelector(".sub-nav-items"),i=e.querySelector(".nav-item");"block"===s.style.display?(s.style.display="none",i.classList.remove("unfolded")):(s.style.display="block",i.classList.add("unfolded"))}}customElements.define("vertical-stacked-navigation-card",st);export{st as VerticalStackedNavCard};
