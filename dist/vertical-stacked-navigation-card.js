 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const f=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),v=` ${r} `;class _{constructor(t,e,s,i){this.strings=t,this.values=e,this.type=s,this.processor=i}getHTML(){const t=this.strings.length-1;let e="",s=!1;for(let i=0;i<t;i++){const t=this.strings[i],n=t.lastIndexOf("\x3c!--");s=(n>-1||s)&&-1===t.indexOf("--\x3e",n+1);const o=m.exec(t);e+=null===o?t+(s?v:a):t.substr(0,o.index)+o[1]+o[2]+c+o[3]+r}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==f&&(e=f.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const k=new class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new P(t,e.slice(1),s).parts}if("@"===n)return[new T(t,e.slice(1),i.eventContext)];if("?"===n)return[new C(t,e.slice(1),s)];return new S(t,e,s).parts}handleTextExpression(t){return new x(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function M(t,e){const{element:{content:s},parts:i}=t,n=document.createTreeWalker(s,133,null,!1);let o=U(i),r=i[o],a=-1,l=0;const c=[];let d=null;for(;n.nextNode();){a++;const t=n.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==r&&r.index===a;)r.index=null!==d?-1:r.index-l,o=U(i,o),r=i[o]}c.forEach((t=>t.parentNode.removeChild(t)))}const R=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,133,null,!1);for(;s.nextNode();)e++;return e},U=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(u(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const q=(t,e)=>`${t}--${e}`;let L=!0;void 0===window.ShadyCSS?L=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),L=!1);const j=t=>e=>{const s=q(e.type,t);let i=$.get(s);void 0===i&&(i={stringsArray:new WeakMap,keyString:new Map},$.set(s,i));let n=i.stringsArray.get(e.strings);if(void 0!==n)return n;const o=e.strings.join(r);if(n=i.keyString.get(o),void 0===n){const s=e.getTemplateElement();L&&window.ShadyCSS.prepareTemplateDom(s,t),n=new d(e,s),i.keyString.set(o,n)}return i.stringsArray.set(e.strings,n),n},I=["html","svg"],F=new Set,H=(t,e,s)=>{F.add(t);const i=s?s.element:document.createElement("template"),n=e.querySelectorAll("style"),{length:o}=n;if(0===o)return void window.ShadyCSS.prepareTemplateStyles(i,t);const r=document.createElement("style");for(let t=0;t<o;t++){const e=n[t];e.parentNode.removeChild(e),r.textContent+=e.textContent}(t=>{I.forEach((e=>{const s=$.get(q(e,t));void 0!==s&&s.keyString.forEach((t=>{const{element:{content:e}}=t,s=new Set;Array.from(e.querySelectorAll("style")).forEach((t=>{s.add(t)})),M(t,s)}))}))})(t);const a=i.content;s?function(t,e,s=null){const{element:{content:i},parts:n}=t;if(null==s)return void i.appendChild(e);const o=document.createTreeWalker(i,133,null,!1);let r=U(n),a=0,l=-1;for(;o.nextNode();)for(l++,o.currentNode===s&&(a=R(e),s.parentNode.insertBefore(e,s));-1!==r&&n[r].index===l;){if(a>0){for(;-1!==r;)n[r].index+=a,r=U(n,r);return}r=U(n,r)}}(s,r,a.firstChild):a.insertBefore(r,a.firstChild),window.ShadyCSS.prepareTemplateStyles(i,t);const l=a.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==l)e.insertBefore(l.cloneNode(!0),e.firstChild);else if(s){a.insertBefore(r,a.firstChild);const t=new Set;t.add(r),M(s,t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`;customElements.define("vertical-stacked-nav-card-editor",class extends tt{constructor(){super(),this._config={nav_items:[]}}setConfig(t){this._config=t}nameChanged(t,e){const s=[...this._config.nav_items];s[e].name=t.detail.value,this._config={...this._config,nav_items:s},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}iconChanged(t,e){const s=[...this._config.nav_items];s[e].icon=t.detail.value,this._config={...this._config,nav_items:s},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}destinationChanged(t,e){const s=[...this._config.nav_items];s[e].destination=t.detail.value,this._config={...this._config,nav_items:s},this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config}}))}render(){return z`
      ${this._config.nav_items.map(((t,e)=>z`
        <h3>Nav Item ${e+1}</h3>
        <paper-input
          .label=${"Name"}
          .value=${t.name}
          @value-changed=${t=>this.nameChanged(t,e)}
        ></paper-input>
        <paper-input
          .label=${"Icon"}
          .value=${t.icon}
          @value-changed=${t=>this.iconChanged(t,e)}
        ></paper-input>
        <paper-input
          .label=${"Destination"}
          .value=${t.destination}
          @value-changed=${t=>this.destinationChanged(t,e)}
        ></paper-input>
      `))}
    `}});customElements.define("vertical-stacked-navigation-card",class extends tt{constructor(){super(...arguments),this.content=null,this.isContentSet=!1}static get styles(){return it}getCardEditor(){return document.createElement("vertical-stacked-nav-card-editor")}render(){const t=this.config.nav_items.map(((t,e)=>{const s=t.active?"active":"",i=t.sub_nav_items?t.sub_nav_items.map((t=>z`
            ...
            <div class="nav-item-container">
                ...
                <ha-icon icon="${t.icon}"></ha-icon>
                <span>${t.name}</span>
                ${t.sub_nav_items?z`<ha-icon icon="mdi:chevron-down" class="subnav-indicator"></ha-icon>`:""}
                </a>
                <div class="sub-nav-items" style="display: ${t.unfolded?"block":"none"}">${i}</div>
            </div>
        `}));return z`
      <ha-card>
        ${"none"!==this.config.nav_name?z`
              <header>
                <style>
                  header {
                    padding-top: 10px;
