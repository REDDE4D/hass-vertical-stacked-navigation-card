...
`;class st extends tt{constructor(){super(...arguments),this.content=null,this.isContentSet=!1}static get styles(){return et}render(){const t=this.config.nav_items.map(((t,e)=>{const s=t.active?"active":"",i=t.sub_nav_items?t.sub_nav_items.map((t=>z`
