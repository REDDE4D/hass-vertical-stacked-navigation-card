 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;const k=new class{handleAttributeExpressions(t,e,s,i){const n=e[0];if("."===n){return new C(t,e.slice(1),s).parts}if("@"===n)return[new E(t,e.slice(1),i.eventContext)];if("?"===n)return[new P(t,e.slice(1),s)];return new S(t,e,s).parts}handleTextExpression(t){return new x(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.4.1");const O=(t,...e)=>new v(t,e,"html",k)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`;class nt extends tt{constructor(){super(...arguments),this.content=null,this.isContentSet=!1}static get styles(){return it}render(){const t=this.config.nav_items.map(((t,e)=>{const s=t.active?"active":"",i=t.sub_nav_items?t.sub_nav_items.map((t=>O`
            ...
            <div class="nav-item-container">
                ...
                <ha-icon icon="${t.icon}"></ha-icon>
                <span>${t.name}</span>
                ${t.sub_nav_items?O`<ha-icon icon="mdi:chevron-down" class="subnav-indicator"></ha-icon>`:""}
                </a>
                <div class="sub-nav-items" style="display: ${t.unfolded?"block":"none"}">${i}</div>
            </div>
        `}));return O`
      <ha-card>
        ${"none"!==this.config.nav_name?O`
              <header>
                <style>
                  header {
                    padding-top: 10px;
    ...
    `}updated(t){var e,s,i,n,o,r,a,l,c,d,h,u,p,m,f,g,_,v;if(this.content||(this.content=this.shadowRoot.querySelector(".card-content")),!this.isContentSet&&this.content&&(this.isContentSet=!0,this.config.custom_styles)){const{colors:t,font_size:y}=this.config.custom_styles;t&&(this.style.setProperty("--main-background-color",null!==(s=null===(e=t.background)||void 0===e?void 0:e.main)&&void 0!==s?s:null),this.style.setProperty("--sub-background-color",null!==(n=null===(i=t.background)||void 0===i?void 0:i.sub)&&void 0!==n?n:null),this.style.setProperty("--main-text-color",null!==(r=null===(o=t.text)||void 0===o?void 0:o.main)&&void 0!==r?r:null),this.style.setProperty("--sub-text-color",null!==(l=null===(a=t.text)||void 0===a?void 0:a.sub)&&void 0!==l?l:null),this.style.setProperty("--main-hover-color",null!==(d=null===(c=t.hover)||void 0===c?void 0:c.main)&&void 0!==d?d:null),this.style.setProperty("--sub-hover-color",null!==(u=null===(h=t.hover)||void 0===h?void 0:h.sub)&&void 0!==u?u:null),this.style.setProperty("--main-active-color",null!==(m=null===(p=t.active)||void 0===p?void 0:p.main)&&void 0!==m?m:null),this.style.setProperty("--sub-active-color",null!==(g=null===(f=t.active)||void 0===f?void 0:f.sub)&&void 0!==g?g:null)),y&&(this.style.setProperty("--main-font-size",null!==(_=y.main)&&void 0!==_?_:null),this.style.setProperty("--sub-font-size",null!==(v=y.sub)&&void 0!==v?v:null))}}handleConfigChanged(t){this.configChanged(t)}setConfigEditor(t){t.setConfig(this.config),t.addEventListener("config-changed",this.handleConfigChanged.bind(this))}configChanged(t){const{config:e}=t.detail;this.setConfig(e),function(t,e,s,i){i=i||{},s=null==s?{}:s;var n=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});n.detail=s,t.dispatchEvent(n)}(this,"config-changed",{config:e})}setConfig(t){if(!t.nav_items)throw new Error("You need to define nav_items");this.config=t}getCardSize(){return 1*this.config.nav_items.length}_toggleSubnav(t){t.preventDefault(),console.log("Toggle subnav triggered");const e=t.target.closest(".nav-item-container");if(!e||!e.querySelector(".sub-nav-items"))return;const s=e.querySelector(".sub-nav-items"),i=e.querySelector(".nav-item");"block"===s.style.display?(s.style.display="none",i.classList.remove("unfolded")):(s.style.display="block",i.classList.add("unfolded"))}}customElements.define("vertical-stacked-navigation-card",nt),window.customCards=window.customCards||[],window.customCards.push({type:"vertical-stacked-navigation-card",name:"Vertical Stacked Navigation Card",preview:!1,description:"Adds a customizable Vertical Stacked Navigation."});export{nt as VerticalStackedNavCard};
